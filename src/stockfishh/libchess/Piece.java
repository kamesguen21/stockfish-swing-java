...
public enum Piece {
	...
	WHITE_PAWN, WHITE_KNIGHT, WHITE_BISHOP, WHITE_ROOK, WHITE_QUEEN, WHITE_KING, BLACK_PAWN, BLACK_KNIGHT, BLACK_BISHOP,
	BLACK_ROOK, BLACK_QUEEN, BLACK_KING, NONE;

	static EnumMap<Piece, PieceType> pieceType = new EnumMap<Piece, PieceType>(Piece.class);
	static EnumMap<Piece, Side> pieceSide = new EnumMap<Piece, Side>(Piece.class);
	private static Piece pieceMake[][] = { { WHITE_PAWN, BLACK_PAWN }, { WHITE_KNIGHT, BLACK_KNIGHT },
